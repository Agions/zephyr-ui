...
class ZephyrThemeData {
  ...
  factory ZephyrThemeData.light() {
    ...
    return ZephyrThemeData(
      ...
      zephyrTextTheme: ZephyrTextTheme(
        headlineLarge: const TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Color(0xFF212121)),
        headlineMedium: const TextStyle(fontSize: 28, fontWeight: FontWeight.w600, color: Color(0xFF212121)),
        headlineSmall: const TextStyle(fontSize: 24, fontWeight: FontWeight.w600, color: Color(0xFF212121)),
        titleLarge: const TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFF212121)),
        titleMedium: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Color(0xFF212121)),
        titleSmall: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFF212121)),
        bodyLarge: const TextStyle(fontSize: 16, fontWeight: FontWeight.normal, color: Color(0xFF212121)),
        bodyMedium: const TextStyle(fontSize: 14, fontWeight: FontWeight.normal, color: Color(0xFF212121)),
        bodySmall: const TextStyle(fontSize: 12, fontWeight: FontWeight.normal, color: Color(0xFF212121)),
        labelLarge: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Color(0xFF212121)),
        labelMedium: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xFF212121)),
        labelSmall: const TextStyle(fontSize: 11, fontWeight: FontWeight.w500, color: Color(0xFF212121)),
      ...
      sideMenuTheme: ZephyrSideMenuTheme(
        ...
        activeItemBackgroundColor: const Color(0xFF1976D2).withValues(alpha: 0.12),
      ...
      stepperTheme: ZephyrStepperTheme(
        ...
        activeTitleTextStyle: const TextStyle(
          fontSize: 14.0,
          fontWeight: FontWeight.w500,
          color: Color(0xFF1976D2),
        ),
        ...
        disabledTitleTextStyle: const TextStyle(
          fontSize: 14.0,
          fontWeight: FontWeight.w500,
          color: Colors.black38,
        ),
        disabledSubtitleTextStyle: const TextStyle(
          fontSize: 12.0,
          color: Colors.black38,
        ),
      ...
      datePickerTheme: ZephyrDatePickerTheme(
        ...
        currentDateBackgroundColor: const Color(0xFF1976D2).withValues(alpha: 0.1),
        ...
        rangeDateBackgroundColor: const Color(0xFF1976D2).withValues(alpha: 0.2),
  ...
  factory ZephyrThemeData.dark() {
    ...
    return ZephyrThemeData(
      ...
      zephyrTextTheme: ZephyrTextTheme(
        headlineLarge: const TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Color(0xFFFFFFFF)),
        headlineMedium: const TextStyle(fontSize: 28, fontWeight: FontWeight.w600, color: Color(0xFFFFFFFF)),
        headlineSmall: const TextStyle(fontSize: 24, fontWeight: FontWeight.w600, color: Color(0xFFFFFFFF)),
        titleLarge: const TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: Color(0xFFFFFFFF)),
        titleMedium: const TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Color(0xFFFFFFFF)),
        titleSmall: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFFFFFFFF)),
        bodyLarge: const TextStyle(fontSize: 16, fontWeight: FontWeight.normal, color: Color(0xFFFFFFFF)),
        bodyMedium: const TextStyle(fontSize: 14, fontWeight: FontWeight.normal, color: Color(0xFFFFFFFF)),
        bodySmall: const TextStyle(fontSize: 12, fontWeight: FontWeight.normal, color: Color(0xFFFFFFFF)),
        labelLarge: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Color(0xFFFFFFFF)),
        labelMedium: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xFFFFFFFF)),
        labelSmall: const TextStyle(fontSize: 11, fontWeight: FontWeight.w500, color: Color(0xFFFFFFFF)),
        primaryColor: const Color(0xFFFFFFFF),
        secondaryColor: const Color(0xB3FFFFFF), // 70% opacity
        errorColor: const Color(0xFFEF5350),
        disabledColor: const Color(0x80FFFFFF), // 50% opacity
      ),
      dividerTheme: const ZephyrDividerTheme(
      ...
      sideMenuTheme: ZephyrSideMenuTheme(
        ...
        activeItemBackgroundColor: const Color(0xFF90CAF9).withValues(alpha: 0.12),
      ...
      datePickerTheme: ZephyrDatePickerTheme(
        ...
        currentDateBackgroundColor: const Color(0xFF90CAF9).withValues(alpha: 0.3),
        ...
        rangeDateBackgroundColor: const Color(0xFF90CAF9).withValues(alpha: 0.2),
        headerBackgroundColor: const Color(0xFF1E1E1E),
