...
class ZephyrThemeDataBuilder {
  ...
  ZephyrThemeData build() {
    return ZephyrThemeData(
      ...
      zephyrTextTheme: _zephyrTextTheme ?? _createDefaultTextTheme(Brightness.light),
      ...
      sideMenuTheme: _sideMenuTheme ?? _createDefaultSideMenuTheme(Brightness.light),
      stepperTheme: _stepperTheme ?? _createDefaultStepperTheme(Brightness.light),
      checkboxGroupTheme: _checkboxGroupTheme ?? _createDefaultCheckboxGroupTheme(Brightness.light),
      radioGroupTheme: _radioGroupTheme ?? _createDefaultRadioGroupTheme(Brightness.light),
      sliderTheme: _sliderTheme ?? _createDefaultSliderTheme(Brightness.light),
      datePickerTheme: _datePickerTheme ?? _createDefaultDatePickerTheme(Brightness.light),
  ...
  static ZephyrTextTheme _createDefaultTextTheme(Brightness brightness) {
    ...
    return ZephyrTextTheme(
      headlineLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: isDark ? Colors.white : const Color(0xFF212121)),
      headlineMedium: TextStyle(fontSize: 28, fontWeight: FontWeight.w600, color: isDark ? Colors.white : const Color(0xFF212121)),
      headlineSmall: TextStyle(fontSize: 24, fontWeight: FontWeight.w600, color: isDark ? Colors.white : const Color(0xFF212121)),
      titleLarge: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: isDark ? Colors.white : const Color(0xFF212121)),
      titleMedium: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: isDark ? Colors.white : const Color(0xFF212121)),
      titleSmall: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: isDark ? Colors.white : const Color(0xFF212121)),
      bodyLarge: TextStyle(fontSize: 16, fontWeight: FontWeight.normal, color: isDark ? Colors.white : const Color(0xFF212121)),
      bodyMedium: TextStyle(fontSize: 14, fontWeight: FontWeight.normal, color: isDark ? Colors.white : const Color(0xFF212121)),
      bodySmall: TextStyle(fontSize: 12, fontWeight: FontWeight.normal, color: isDark ? Colors.white : const Color(0xFF212121)),
      labelLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: isDark ? Colors.white : const Color(0xFF212121)),
      labelMedium: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: isDark ? Colors.white : const Color(0xFF212121)),
      labelSmall: TextStyle(fontSize: 11, fontWeight: FontWeight.w500, color: isDark ? Colors.white : const Color(0xFF212121)),
      primaryColor: isDark ? Colors.white : const Color(0xFF212121),
      secondaryColor: isDark ? const Color(0xB3FFFFFF) : const Color(0xFF757575),
  ...
  static ZephyrIconTheme _createDefaultIconTheme(Brightness brightness) {
    ...
    return ZephyrIconTheme(
      ...
      secondaryColor: isDark ? const Color(0xFF80CBC4) : const Color(0xFF26A69A),
      errorColor: const Color(0xFFD32F2F),
  ...
  static ZephyrSideMenuTheme _createDefaultSideMenuTheme(Brightness brightness) {
    final isDark = brightness == Brightness.dark;
    return ZephyrSideMenuTheme(
      ...
      activeItemBackgroundColor: (isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2)).withValues(alpha: 0.12),
      iconColor: isDark ? Colors.white70 : Colors.black54,
      activeIconColor: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2),
      dividerColor: isDark ? Colors.white24 : Colors.black12,
      dividerThickness: 1.0,
      headerBackgroundColor: isDark ? const Color(0xFF1E1E1E) : const Color(0xFFF5F5F5),
      headerTextStyle: TextStyle(
        fontSize: 16.0,
        fontWeight: FontWeight.w600,
        color: isDark ? Colors.white : Colors.black87,
      ),
      footerBackgroundColor: isDark ? const Color(0xFF1E1E1E) : const Color(0xFFF5F5F5),
      selectedItemColor: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2),
  ...
  static ZephyrStepperTheme _createDefaultStepperTheme(Brightness brightness) {
    ...
    return ZephyrStepperTheme(
      ...
      activeSubtitleTextStyle: TextStyle(
        fontSize: 12.0,
        color: (isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2)).withValues(alpha: 0.8),
      ),
      ...
      errorTitleTextStyle: const TextStyle(
        fontSize: 14.0,
        fontWeight: FontWeight.w500,
  ...
  static ZephyrCheckboxGroupTheme _createDefaultCheckboxGroupTheme(Brightness brightness) {
    final isDark = brightness == Brightness.dark;
    return ZephyrCheckboxGroupTheme(
      activeColor: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2),
      checkColor: isDark ? Colors.black : Colors.white,
      borderColor: isDark ? const Color(0xB3FFFFFF) : const Color(0xFF757575),
      disabledBorderColor: isDark ? const Color(0x80FFFFFF) : const Color(0xFFBDBDBD),
      textStyle: TextStyle(
        fontSize: 14,
  ...
  static ZephyrRadioGroupTheme _createDefaultRadioGroupTheme(Brightness brightness) {
    final isDark = brightness == Brightness.dark;
  ...
  static ZephyrSliderTheme _createDefaultSliderTheme(Brightness brightness) {
    ...
    return ZephyrSliderTheme(
      activeTrackColor: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2),
      inactiveTrackColor: isDark ? const Color(0x52FFFFFF) : const Color(0x52000000),
      hoverActiveTrackColor: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2),
      hoverInactiveTrackColor: isDark ? const Color(0xB3FFFFFF) : const Color(0xFF757575),
      disabledActiveTrackColor: isDark ? const Color(0x80FFFFFF) : const Color(0xFFBDBDBD),
      disabledInactiveTrackColor: isDark ? const Color(0x1FFFFFFF) : const Color(0x1F000000),
      thumbColor: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2),
      hoverThumbColor: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2),
      disabledThumbColor: isDark ? const Color(0x80FFFFFF) : const Color(0xFFBDBDBD),
      thumbShadowColor: isDark ? Colors.black54 : Colors.black26,
      valueIndicatorColor: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2),
      valueIndicatorTextStyle: TextStyle(
        color: isDark ? Colors.black : Colors.white,
        fontSize: 12.0,
      ),
      thumbBorderColor: isDark ? Colors.black12 : Colors.white,
      hoverThumbBorderColor: isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2),
      disabledThumbBorderColor: isDark ? const Color(0x80FFFFFF) : const Color(0xFFBDBDBD),
    );
  }

  static ZephyrDatePickerTheme _createDefaultDatePickerTheme(Brightness brightness) {
    final isDark = brightness == Brightness.dark;
    final primaryColor = isDark ? const Color(0xFF90CAF9) : const Color(0xFF1976D2);
    ...
    return ZephyrDatePickerTheme(
      ...
      currentDateBackgroundColor: primaryColor.withValues(alpha: isDark ? 0.3 : 0.1),
      ...
      headerBackgroundColor: isDark ? const Color(0xFF1E1E1E) : const Color(0xFFE3F2FD),
...
class ZephyrOptimizedThemeData extends ZephyrThemeData {
  ...
  ZephyrOptimizedThemeData({
    ...
    required ZephyrButtonTheme buttonTheme,
    required ZephyrTextTheme zephyrTextTheme,
    required ZephyrDividerTheme dividerTheme,
    required ZephyrIconTheme iconTheme,
    required ZephyrBadgeTheme badgeTheme,
    required ZephyrSideMenuTheme sideMenuTheme,
    required ZephyrStepperTheme stepperTheme,
    required ZephyrCheckboxGroupTheme checkboxGroupTheme,
    required ZephyrRadioGroupTheme radioGroupTheme,
    required ZephyrSliderTheme sliderTheme,
    required ZephyrDatePickerTheme datePickerTheme,
    ZephyrAccordionTheme? accordionTheme,
    ZephyrSkeletonTheme? skeletonTheme,
    ZephyrPaginationTheme? paginationTheme,
    required ZephyrRatingTheme ratingTheme,
    required ZephyrTreeTheme treeTheme,
    required ZephyrTourTheme tourTheme,
  ...
  static ZephyrOptimizedThemeData createLightBasic() {
    return ZephyrOptimizedThemeData(
      ...
      zephyrTextTheme: ZephyrThemeDataBuilder._createDefaultTextTheme(Brightness.light),
      dividerTheme: const ZephyrDividerTheme(),
      iconTheme: ZephyrThemeDataBuilder._createDefaultIconTheme(Brightness.light),
      badgeTheme: ZephyrThemeDataBuilder._createDefaultBadgeTheme(),
      sideMenuTheme: ZephyrThemeDataBuilder._createDefaultSideMenuTheme(Brightness.light),
      stepperTheme: ZephyrThemeDataBuilder._createDefaultStepperTheme(Brightness.light),
      checkboxGroupTheme: ZephyrThemeDataBuilder._createDefaultCheckboxGroupTheme(Brightness.light),
      radioGroupTheme: ZephyrThemeDataBuilder._createDefaultRadioGroupTheme(Brightness.light),
      sliderTheme: ZephyrThemeDataBuilder._createDefaultSliderTheme(Brightness.light),
      datePickerTheme: ZephyrThemeDataBuilder._createDefaultDatePickerTheme(Brightness.light),
  ...
  static ZephyrOptimizedThemeData createDarkBasic() {
    return ZephyrOptimizedThemeData(
      ...
      zephyrTextTheme: ZephyrThemeDataBuilder._createDefaultTextTheme(Brightness.dark),
      dividerTheme: const ZephyrDividerTheme(
        color: Color(0x33FFFFFF),
      ),
      iconTheme: ZephyrThemeDataBuilder._createDefaultIconTheme(Brightness.dark),
      badgeTheme: ZephyrThemeDataBuilder._createDefaultBadgeTheme(),
      sideMenuTheme: ZephyrThemeDataBuilder._createDefaultSideMenuTheme(Brightness.dark),
      stepperTheme: ZephyrThemeDataBuilder._createDefaultStepperTheme(Brightness.dark),
      checkboxGroupTheme: ZephyrThemeDataBuilder._createDefaultCheckboxGroupTheme(Brightness.dark),
      radioGroupTheme: ZephyrThemeDataBuilder._createDefaultRadioGroupTheme(Brightness.dark),
      sliderTheme: ZephyrThemeDataBuilder._createDefaultSliderTheme(Brightness.dark),
      datePickerTheme: ZephyrThemeDataBuilder._createDefaultDatePickerTheme(Brightness.dark),
