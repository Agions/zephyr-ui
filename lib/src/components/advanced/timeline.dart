...
class ZProcessTimeline extends StatefulWidget {
  ...
  @override
  State<ZProcessTimeline> createState() => _ZProcessTimelineState();
}

class _ZProcessTimelineState extends State<ZProcessTimeline> {
  @override
  Widget build(BuildContext context) {
    switch (widget.style) {
