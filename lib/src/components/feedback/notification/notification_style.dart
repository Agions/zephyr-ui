...
class VelocityNotificationStyle {
  const VelocityNotificationStyle({
    ...
    this.boxShadow = const [BoxShadow(color: Colors.black12, blurRadius: 12, offset: Offset(0, 4))],
    this.titleStyle = const TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: VelocityColors.gray900),
    this.messageStyle = const TextStyle(fontSize: 13, color: VelocityColors.gray600),
    this.iconSize = 24,
    this.iconSpacing = 12,
