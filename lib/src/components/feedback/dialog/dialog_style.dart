...
class VelocityDialogStyle {
  const VelocityDialogStyle({
    ...
    this.contentStyle = const TextStyle(fontSize: 14, color: VelocityColors.gray600),
    this.confirmButtonStyle = const TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: VelocityColors.primary),
    this.cancelButtonStyle = const TextStyle(fontSize: 14, color: VelocityColors.gray500),
  });
