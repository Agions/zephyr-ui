...
class VelocityIcon extends StatelessWidget {
  ...
  double get _size {
    ...
    switch (size) {
      case VelocityIconSize.xs: return 14;
      case VelocityIconSize.sm: return 18;
      case VelocityIconSize.md: return 24;
      case VelocityIconSize.lg: return 32;
      case VelocityIconSize.xl: return 48;
    }
  }
